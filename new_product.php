...
<body>
    <main class="form-container">
        ...
        <form method="POST" class="admin-form" action="products_admin.php" enctype="multipart/form-data">
            ...
            <textarea name="product-desc" id="product-desc" rows="3"></textarea>
            <h4>Ceny:</h4>
            <div class="prices">
                <label for="product-price-sm">Mała</label>
                <input type="text" name="product-price-sm" id="product-price-sm" class="price"><span>zł</span>
                <label for="product-price-md">Średnia</label>
                <input type="text" name="product-price-md" id="product-price-sm" class="price"><span>zł</span>
                <label for="product-price-lg">Duża</label>
                <input type="text" name="product-price-lg" id="product-price-sm" class="price"><span>zł</span>
            </div>
            <button type="submit" name="product-submit">Opublikuj</button>
        </form>
    </main>
